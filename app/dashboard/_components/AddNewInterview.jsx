...
import { chatSession } from '../../../utils/GeminiAIModela.js'
...
function AddNewInterview() {
    ...
    const onSubmit = async (e) => {
        ...
        const InputPrompt = `Job position: ${jobPostion}, Job Description: ${jobDesc}, Years of Experience: ${jobExperience}, Depends on Job Position, Job Description and Years of Experience give us ${process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT} Interview question along with Answer in JSON format, Give us question and Answer field on JSON,Each question and answer should be in the format:
  {
    "question": "Your question here",
    "answer": "Your answer here"
  }
    
  Resposnse should only be in above JSON format with no extra field or whatsoever.
    `
  ;
        ...
        console.log("Add new Interview section",MockJsonResp)
  ...
  return (
    <div>
      <div className='p-10 border rounded-lg bg-secondary hover:scale-105 hover:shadow-md cursor-pointer transition-all hover:font-bold'
