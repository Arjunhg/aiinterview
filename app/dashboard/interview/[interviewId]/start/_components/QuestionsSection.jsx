    ...
    <div className='p-5 border rounded-lg my-10'>
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
        ...
        {mockInterviewQuestion && mockInterviewQuestion.map((questions, index) => (
            ...
            <h2 
              className={`p-2 bg-secondary rounded-full text-xs md:text-sm text-center cursor-pointer ${activeQuestionIndex==index && 'bg-blue-500 text-blue-500'}`}>
              Question #{index+1}    
            </h2>
        ))}
